...
(* Global Instance trunc_baut `{Univalence} {n X} {H0:IsTrunc@{i i'} n.+1 X} *)
(* : IsTrunc@{j j'} n.+2 (BAut X). *)
(* Proof. *)
(*   intros [Z p] [W q]. *)
(*   strip_truncations. *)
...
(* Definition center_baut `{Univalence} X {H0:IsTrunc@{i i'} 0 X} *)
